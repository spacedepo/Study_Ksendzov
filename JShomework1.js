// Написать функцию, которая найдет и выведет в консоль юзеров, зарегистрированных 11.10.2021 и 10.10.2021). Массив в task1.txt
...
users.forEach(user => {
    if (user.registrationDate == '10.10.2021' || user.registrationDate == '11.10.2021') console.log(user)
});